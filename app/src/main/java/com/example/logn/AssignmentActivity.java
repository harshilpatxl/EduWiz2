...
public class AssignmentActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            ...
            else if(selectedAnswer.equals(QuestionAnswer.choices[currentQuestionIndex][0])){
                score+=1;
            }
    ...
    void finishQuiz(){
        String passStatus = "";
        if(score < 5){
            passStatus = "Counsellor Required";
        }else if (score >= 5 && score <10){
            passStatus = "Meditation Required";
        }
        else{
            passStatus = "Passed";
        }
        ...
        new AlertDialog.Builder(this)
                .setTitle(passStatus)
                .setMessage("Score is "+ score+" out of "+ totalQuestion*4)
